...
//   if (event.ctrlKey && event.altKey && event.code === 'Numpad1') { // 숫자패드 1
//     // '저장' 기능 수행
...
//   }
//   if (event.ctrlKey && event.altKey && event.code === 'Numpad2') { // 숫자패드 2
//     // '불러오기' 기능 수행
...
//     // 파일을 읽는 도중 오류가 발생했을 때 콘솔에 오류를 출력합니다.
//     console.error('파일을 읽는 도중 오류가 발생했습니다.', e);
//   };
